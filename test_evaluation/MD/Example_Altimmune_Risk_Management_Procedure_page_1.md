...
<!-- PageHeader="Standard Operating Procedure" -->
<!-- PageHeader="TITLE" -->
<!-- PageHeader="Document Number" -->
<!-- PageHeader="XX-###.##" -->
<!-- PageHeader="Version X" -->
<!-- PageHeader="Effective Date" -->
<!-- PageHeader="DDMMMYYYY" -->
<!-- PageHeader="DRAFTDraft Copy" -->
<!-- PageHeader="SOP Number:" -->
<!-- PageHeader="PD-002" -->
<!-- PageHeader="Version:" -->
<!-- PageHeader="1" -->
<!-- PageHeader="Page 8 of 28" -->
<!-- PageHeader="Effective Date:" -->
<!-- PageHeader="Title:" -->
<!-- PageHeader="Risk Management Procedure for Combination Products" -->
<!-- PageHeader="DRAFT" -->
...
<td>Any product composed of any combination of a drug and a device; a biological product and a device; a drug and a biological product; or a drug, device and a biological product.</td>
</tr>
<tr>
<td>Harm</td>
...
<tr>
<td>Are substances delivered to or extracted from the patient? Factors that should be considered include: whether the substance is delivered or extracted whether it is a single substance or range of substances the maximum and minimum transfer rates control of the transfer rates</td>
</tr>
<tr>
...
<!-- PageFooter="Management Approval:" -->
<!-- PageFooter="Michael A. Dorato," -->
<!-- PageFooter="Executive Vice President" -->
<!-- PageFooter="Date:" -->
<!-- PageFooter="QA Management Review:" -->
<!-- PageFooter="Peggy A. Miller," -->
<!-- PageFooter="Director, QA" -->
<!-- PageFooter="Date:" -->
<!-- PageFooter="CONFIDENTIAL" -->
<!-- PageFooter="CONFIDENTIAL – DO NOT DISTRIBUTE" -->